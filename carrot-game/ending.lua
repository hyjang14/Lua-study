...
function scene:create( event )
	...
	text = composer.getVariable("text")

	local endingText = display.newText(text, display.contentWidth/2, display.contentHeight*0.4)
 	endingText.size = 200
	...
	--replay 선택하면 다시 game.lua로 이동해서 플레이할 수 있게끔 
